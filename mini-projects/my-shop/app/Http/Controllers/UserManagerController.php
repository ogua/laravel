...
//        return $request;
    ...
    public function banUser(Request $request){
        ...
        return redirect()->back()->with("toast",['icon'=>'success','title'=>$currentUser->name." is baned"]);
    }
    ...
    public function restoreUser(Request $request){
        ...
        return redirect()->back()->with("toast",['icon'=>'success','title'=>$currentUser->name." is restore"]);
    }
